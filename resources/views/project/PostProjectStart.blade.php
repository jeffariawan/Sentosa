                    ...
                    <form action="{{ route('project.PostProjectStart.store') }}" method="post" class="php-email-form">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6 mt-2">
                                <input name="minBudget" class="form-control" type="text" placeholder="Minimal Budget"
                                    required>
                            </div>
                            <div class="col-md-6 mt-2">
                                <input name="maxBudget" class="form-control" type="text" placeholder="Maximal Budget"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="timeEstimation" class="form-control" type="number" placeholder="Time estimation"
                                required>
                        </div>
